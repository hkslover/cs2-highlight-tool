...
export function AckChangelog(arg1) {
  return window['go']['app']['App']['AckChangelog'](arg1);
}
...
export function ClearDebugPluginDLLOverride() {
  return window['go']['app']['App']['ClearDebugPluginDLLOverride']();
}
...
export function GetDebugPluginDLLOverride() {
  return window['go']['app']['App']['GetDebugPluginDLLOverride']();
}
...
export function GetPendingChangelog() {
  return window['go']['app']['App']['GetPendingChangelog']();
}
...
export function PickDebugPluginDLLOverride() {
  return window['go']['app']['App']['PickDebugPluginDLLOverride']();
}
